...
export default function displayMainMenu(categories) {
  console.clear();
...
export function displayAdminMenu(categories) {
  console.clear();
...
export function displayUserMenu(categories) {
  console.clear();
